...
from Models.inference.domain_seg_infer import DomainSegNetworkInfer
...
def main(): 
  ...
  parser.add_argument(
    ...
    help = "Path to input video which will be processed by DomainSeg."
  )
  parser.add_argument(
    "-o", 
    "--output_file", 
    dest = "output_video_filepath", 
